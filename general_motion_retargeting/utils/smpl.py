...
def load_gvhmr_pred_file(
    ...
    print(
        smplx_data, "\n",
        body_model, "\n",
        smpl_params_global['body_pose'].shape, "\n",
        smplx_data["betas"].shape, "\n",
        smplx_data["root_orient"].shape, "\n",
        smplx_data["pose_body"].shape, "\n",
        smplx_data["trans"].shape, "\n",
    )
